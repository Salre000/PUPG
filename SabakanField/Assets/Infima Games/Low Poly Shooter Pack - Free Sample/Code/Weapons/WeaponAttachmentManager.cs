...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class WeaponAttachmentManager : WeaponAttachmentManagerBehaviour
    {
        ...
        [SerializeField,Header("アイアンサイトを武器モデルに表示するかどうかを決定します")]
        private bool scopeDefaultShow = true;
        
        [Tooltip("Default Scope!"),Header("デフォルトの！！スコープ！！！！")]
        [SerializeField]
        ...
        [SerializeField,Header("この武器が使用可能なすべてのマズルアタッチメント")]
        ...
        [SerializeField,Header("この武器が使用可能なすべてのマガジン・アタッチメント")]
