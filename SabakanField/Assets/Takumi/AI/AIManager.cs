...
public class AIManager : MonoBehaviour
{
    ...
    public void AddDeathCount(int index) { kIll.deathCount[index]++;UnityEngine.Debug.Log("**死んだ"); }
    public void AdDKillCount(int index) { kIll.killCount[index]++; UnityEngine.Debug.Log("**殺した"); }
